...
Workspace is a collaborative space for your team to get started with experimenting and testing your AI application. All of the features such as prompts, workflows, data sets, context sources, evaluators, and test runs are isolated in a workspace i.e. these features are not shared across workspaces. You can have multiple workspaces associated with one account.
